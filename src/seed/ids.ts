...
// Seed recipients — mirror Kimana_frontend/src/api/mock/seed.ts.
export const DEMO_RECIPIENT_AMSTERDAM = '00000000-0000-4000-8000-000000000020';
export const DEMO_RECIPIENT_KERALA = '00000000-0000-4000-8000-000000000021';
export const DEMO_RECIPIENT_NATURALIA = '00000000-0000-4000-8000-000000000022';
export const DEMO_RECIPIENT_ROTTERDAM = '00000000-0000-4000-8000-000000000023';
export const DEMO_RECIPIENT_GUPTA = '00000000-0000-4000-8000-000000000024';
